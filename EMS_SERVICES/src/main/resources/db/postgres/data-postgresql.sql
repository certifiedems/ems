...
DO UPDATE SET
    ...
    low_severity_percentage = EXCLUDED.low_severity_percentage,
    medium_severity_percentage = EXCLUDED.medium_severity_percentage,
    high_severity_percentage = EXCLUDED.high_severity_percentage,
